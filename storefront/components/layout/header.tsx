        ...
        <div className="container-custom">
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <Link href="/" className="flex items-center gap-2">
              <div className="flex items-center justify-center w-7 h-7 bg-foreground rounded">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div
            ...
            className="absolute inset-y-0 left-0 w-80 max-w-[85vw] bg-background animate-fade-in"
          >
            <div className="flex items-center justify-between p-4 border-b">
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center w-6 h-6 bg-foreground rounded">
                  <Zap className="h-3.5 w-3.5 text-background fill-current" />
                </div>
                <span className="font-heading text-lg font-bold">LumiX</span>
              </div>
              <button
